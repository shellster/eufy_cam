...
**Multiple cameras simultaneously:** Each camera stream establishes its own dedicated P2P connection to the hub, so multiple cameras can stream concurrently without interfering with each other.
